...
public class ViewReportServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<title>Reports Dashboard</title>");
            ...
            out.println("<a href='secretary.jsp' class='back-button'>Back to Secretary Dashboard</a>");
            ...
            out.println("<th>Uploaded Report</th>");
            ...
            try (Connection con = DBUtil.getConnection()) {
                ...
                try (PreparedStatement ps = con.prepareStatement(sql);
                    ...
                    while (rs.next()) {
                        ...
                        out.println("<td><a href='DownloadReportServlet?Rep_Id=" + rs.getInt("Rep_Id") + "'>Download</a></td>");
                        out.println("<td><a href='DeleteReportServlet?Rep_Id=" + rs.getInt("Rep_Id") + "'>Delete</a></td>");
                        out.println("</tr>");
                    }
                }
    ...
    public String getServletInfo() {
        return "ViewReportServlet for displaying report data";
    }
}
