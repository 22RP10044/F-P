...
public class ApprdafServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try (Connection con = DBUtil.getConnection()) {
                String sql = "SELECT Id,person_name,Purpose_of_mission,Destination,Date_of_dispatcher from creation";
                ...
                try (PreparedStatement ps = con.prepareStatement(sql);
                    ...
                    while (rs.next()) {
                        ...
                        out.println("<td>");
                        out.println("<a href='UpdateMissionServlet?id=" + rs.getInt("Id") + "'>Approve</a> | ");
                        out.println("<a href='DeleteMissionServlet?id=" + rs.getInt("Id") + "'>Reject</a>");
                        out.println("</td>");
                        out.println("</tr>");
                    }
                }
