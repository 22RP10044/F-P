...
@WebServlet("/RetrieveMission")
public class RetrieveMission extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h2>Approved Missions List</h2>");
            out.println("<table>");
            out.println("<thead>");
            out.println("<tr>");
            ...
            try (Connection con = DBUtil.getConnection()) {
                ...
                try (PreparedStatement ps = con.prepareStatement(sql);
                    ...
                    while (rs.next()) {
                        ...
                        out.println("<td>" + rs.getString("Mission_allowance") + "</td>");
                        out.println("<td>" + rs.getString("Name_of_supervisor") + "</td>");
                        out.println("<td>" + rs.getString("Status") + "</td>");
                        out.println("<td><a href='EditServlet?id=" + rs.getInt("Id") + "'>Edit</a> | <a href='DeleteServlet?id=" + rs.getInt("Id") + "'>Delete</a></td>");
                        out.println("</tr>");
                    }
                } catch (SQLException ex) {
                    out.println("<tr><td colspan='15'>Error: " + ex.getMessage() + "</td></tr>");
                }
            } catch (SQLException ex) {
                out.println("<tr><td colspan='15'>Error: " + ex.getMessage() + "</td></tr>");
            }
    ...
    public String getServletInfo() {
        return "RetrieveMissionServlet for fetching approved missions";
    }
}
