                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">
                                    Secretary&nbsp;&nbsp;<img class="img-profile rounded-circle" src="<c:url value='/uploadeddata/1.png'/>">
                                </span>
                            </a>
                                ...
                                <a href="RetrieveMissionServlet">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Issue mission order</div>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <a href="RetrieveMissionServlet">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Assigned missions</div>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <a href="RetrieveMissionServlet">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">View mission status</div>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <a href="RetrieveMissionServlet">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Provide Feedback on mission</div>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <a href="RetrieveMissionServlet">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Request mission Report</div>
                                            </div>
                                        </div>
                                    </div>
                                </a>
